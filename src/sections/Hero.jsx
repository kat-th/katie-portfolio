...
const skills = [
  ...
  "R",
  "ETL Pipeline",
  "AWS (Glue, Athena, Redshift, Lambda, S3, SageMaker)",
  "GCP",
  "Git",
  "GitHub Actions",
  "Machine Learning",
...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="container max-w-7xl mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center justify-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/kat-th" },
                {
                  icon: Linkedin,
                  href: "https://www.linkedin.com/in/katieha/",
                },
                { icon: Twitter, href: "#" },
              ].map((social, idx) => (
                <a
                  ...
                  className="p-2 rouned-full glass hover:bg-primary/10 hover:text-primary transition-all duration-300"
                >
